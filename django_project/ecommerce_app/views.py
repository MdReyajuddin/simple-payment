...
def process_payment(request):
    ...
    param_dict = {
        ...
        'WEBSITE': 'WEBSTAGING',
        'CHANNEL_ID': 'WEB',
        'CALLBACK_URL': 'http://127.0.0.1:8000/payment_done/',

    }

    param_dict['CHECKSUMHASH'] = Checksum.generate_checksum(param_dict, MERCHANT_KEY)
    return render(request, 'blog/process_payment.html', {'param_dict': param_dict})
...
def payment_done(request):
    ...
    return render(request, 'blog/paymentstatus.html', {'response': response_dict})
